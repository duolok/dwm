...
static char *fonts[]          = { "FiraCode:size=10", "JoyPixels:pixelsize=10:antialias=true:autohint=true"  };
static char normbgcolor[]           = "#1d1d1d";
static char normbordercolor[]       = "#19192d";
static char normfgcolor[]           = "#ffffff";
static char selfgcolor[]            = "#ffffff";
static char selbordercolor[]        = "#1b2432";
static char selbgcolor[]            = "#060F19";
...
static Key keys[] = {
	...
	{ 0, XF86XK_MonrightnessDown,	spawn,		SHCMD("xbacklight -dec 5") },*/
